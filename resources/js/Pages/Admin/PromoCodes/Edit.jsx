...
export default function Edit({ promoCode }) {
    const { data, setData, put, processing, errors } = useForm({
        ...
        min_cart_value: promoCode.min_cart_value || '0',
    ...
    return (
        <AuthenticatedLayout>
            <Head title={`Edit Promo Code: ${promoCode.code}`} />
                        ...
                        <CardContent className="space-y-6">
                            ...
                            <div className="grid gap-6 sm:grid-cols-2">
                                <div className="space-y-2">
                                    ...
                                    <p className="text-xs text-muted-foreground">
                                        {promoCode.used_count > 0
                                            ? `Already used ${promoCode.used_count} times. Leave blank for unlimited uses.`
